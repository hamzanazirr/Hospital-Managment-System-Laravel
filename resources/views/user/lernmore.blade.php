        ...
        <div class="container" >
            <div class="row justify-content-center" >
                <div class="col-md-4 py-3 py-md-0" >
                    <div class="card-service wow fadeInUp " style="background:transparent">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 py-3 wow fadeInUp">
                    ...
                    <a href="https://en.wikipedia.org/wiki/Physical_fitness" class="btn btn-outline-info">Learn More</a>
                </div>
