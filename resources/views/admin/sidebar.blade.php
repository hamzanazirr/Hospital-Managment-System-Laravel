<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
            ...
            <div class="profile-desc">
                <div class="profile-pic">
                    ...
                    <div class="profile-name">
                        <h5 class="mb-0 font-weight-normal">MX Hamza</h5>
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('show_admin_appi')}}">
                <span class="menu-icon">
                    <i class="mdi mdi-speedometer"></i>
                </span>
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('add_bloge')}}">
                <span class="menu-icon">
                    <i class="mdi mdi-speedometer"></i>
                </span>
                <span class="menu-title">Add Bloge</span>
            </a>
        </li>

        <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('show_admian_bloge')}}">
                <span class="menu-icon">
                    <i class="mdi mdi-speedometer"></i>
                </span>
                <span class="menu-title">Bloge</span>
            </a>
        </li>
